...
def add_cover_page(doc, kind, title, version, conducted_by=ORG,
    ...
    org_logo: Tertiary Infotech Academy logo path; course_logo: CKAD course logo path."""
    doc.add_paragraph()
    ...
    _img(doc, course_logo, 1.0)                           # course logo (skipped if missing)
